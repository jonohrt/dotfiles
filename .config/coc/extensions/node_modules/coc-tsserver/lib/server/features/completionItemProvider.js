...
class TypeScriptCompletionItemProvider {
    constructor(client, typingsStatus, fileConfigurationManager, bufferSyncSupport, languageId) {
        this.client = client;
    ...
    provideCompletionItems(document, position, token, context) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this.client.apiVersion.gte(api_1.default.v300)) {
                try {
                    const response = yield this.bufferSyncSupport.interuptGetErr(() => this.client.execute('completionInfo', args, token));
                ...
                const response = yield this.bufferSyncSupport.interuptGetErr(() => this.client.execute('completions', args, token));
                if (response.type !== 'response' || !response.body) {
                    return null;
                }
                msg = response.body;
