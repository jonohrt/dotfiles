...
&nbsp;
  _appendCallback = (numSpans: number, err?: string) =&gt; {
    if (<span class="missing-if-branch" title="if path not taken" >I</span>err) {
      this.<span class="cstat-no" title="statement not covered" >_logger.error(`Failed to append spans in reporter: ${err}`);</span>
      this.<span class="cstat-no" title="statement not covered" >_metrics.reporterDropped.increment(numSpans);</span>
    } else {
