  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>131/135</span>
      </div>
    </div>
  </div>
...
&nbsp;
    ...
    for (let i = 0; i &lt; references.length; i++) {
      ...
      if (<span class="missing-if-branch" title="else path not taken" >E</span>ref.type() === opentracing.REFERENCE_CHILD_OF) {
        i</span>f (<span class="missing-if-branch" title="else path not taken" >E</span>!parent || <span class="branch-1 cbranch-no" title="branch not covered" >followsFromIsParent) {
          parent = ref.referencedContext();
          break;
        }
      } else <span class="cstat-no" title="statement not covered" >if (ref.type() === opentracing.REFERENCE_FOLLOWS_FROM) {</span>
        if (<span class="cstat-no" title="statement not covered" >!parent) {</span>
          parent = <span class="cstat-no" title="statement not covered" >ref.referencedContext();</span>
          followsFromIsParent = <span class="cstat-no" title="statement not covered" >true;</span>
        }
      }
    }
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Aug 06 2018 17:14:34 GMT-0400 (EDT)
</div>
</div>
