...
" Plugins
source ~/.config/nvim/plugin/deoplete.vim
source ~/.config/nvim/plugin/vimwiki.vim
source ~/.config/nvim/plugin/fzf.vim
source ~/.config/nvim/plugin/tcomment.vim
source ~/.config/nvim/plugin/targets.vim
source ~/.config/nvim/plugin/ultisnips.vim
source ~/.config/nvim/plugin/vimtest.vim
source ~/.config/nvim/plugin/neomake.vim
source ~/.config/nvim/plugin/undotree.vim
