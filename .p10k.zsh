# Generated by Powerlevel10k configuration wizard on 2019-09-24 at 22:40 PDT.
...
POWERLEVEL9K_VI_INSERT_MODE_STRING="%BINSERT%b%K{cyan}"
POWERLEVEL9K_VI_COMMAND_MODE_STRING="%BNORMAL%b%K{green}"
